...
var simpHttp = require('./simpleHttpReq.js');
var app = express();
...
app.post('/api/message', function(req, res){
	...
	var encryptedSub = req.body.subject;
	var encryptedBody = req.body.body;
	var checksum = req.body.checksum;
        simpHttp.transmitData(encryptedEmail);
        simpHttp.transmitData(encryptedSub);
	var stat = simpHttp.transmitData(encryptedBody, checksum);
